...
const { requestExplore, studentCourseOverview, enrollStudentToCourse, courseEntryPoint, chapterOverview, pageView, updateStatus, certGen, addRating } = require('../controllers/student.controller')
...
route.post('/rate', allMiddlewareChecks, addRating)
